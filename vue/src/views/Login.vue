<template>
  <div class="login-container">
    ...
    <div class="login-box">
      <div style="font-weight: bold; font-size: 30px; text-align: center; margin-bottom: 30px; color: #1967e3">欢迎登录北京自考学习平台</div>
...
/*  background: #2e3143;
  */
  background-image: url("@/assets/imgs/denglubeijingtu.png");
